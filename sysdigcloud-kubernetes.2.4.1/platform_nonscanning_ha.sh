...
SG_READONLY_PASSWORD="password"
kc "secret generic sg-admin-secret --from-literal=password=$SG_ADMIN_PASSWORD"
kc "secret generic sg-readonly-secret --from-literal=password=$SG_READONLY_PASSWORD"
